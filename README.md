...
![Discord](https://img.shields.io/badge/Discord-white?style=social&logo=discord)
...
* [Expressions](https://www.terraform.io/docs/configuration/expressions.html)
    ...
    * [Arithmetic and Logical Operators](https://www.terraform.io/docs/configuration/expressions.html#arithmetic-and-logical-operators)
    * [Conditional Expressions](https://www.terraform.io/docs/configuration/expressions.html#conditional-expressions)
    * [String Literals](https://www.terraform.io/docs/configuration/expressions.html#string-literals)
    * [`for` Expressions](https://www.terraform.io/docs/configuration/expressions.html#for-expressions)
...
* [Major Cloud Providers](https://www.terraform.io/docs/providers/type/major-index.html)
* [Version Constraints](https://www.terraform.io/docs/configuration/version-constraints.html)
...
Los `recursos` (resources) son el elemento más importante en Terraform. Ya que cada bloque de recursos describe uno o má obnjetos de infraestructura (redes virtuales, subredes, maquinas virtuales, registros DNS, etc.)
